  ...
  return (
    <section className="relative bg-white  py-16">
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
        <div className="ps-20">
          <h3 className="text-[60px] sm:text-[80px] font-bold text-[#B97E63] leading-none">
            01
          </h3>
          ...
          <p className="mt-4 text-base sm:text-lg text-gray-800">
            Experts at Kapiva Academy of Ayurveda, Ph.D.'s, and Ayurvedacharya
            with over 50 years of cumulative experience build formulations with
            scientifically and clinically tested ingredients, to make our
      ...
      <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
        ...
        <div className="order-1 md:order-2 text-end pe-20">
          ...
          <p className="mt-4 text-base sm:text-lg text-gray-800">
            Our formulations undergo clinical validation and testing to ensure
            safety and effectiveness. Kapiva’s commitment to Ayurvedic
            principles and modern science results in products you can trust for
      ...
      <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
        <div className="ps-20">
          ...
          <p className="mt-4 text-base sm:text-lg text-gray-800">
            Kapiva ensures sustainability by sourcing ingredients naturally and
            ethically. Our processes respect the environment while delivering
            high-quality, potent Ayurvedic products to support your health
            holistically.
          </p>
        </div>
        <div className="flex justify-center md:justify-end">
